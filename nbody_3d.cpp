...
int main(){
    vector<Body> o ={Body(100,0,0,0,0,0,0),Body(1,16,0,0,0,2.5,1),Body(1,25,0,0,0,2.49,-1)};
    double t_start = 0;
    double t_end = 10000;
    double h = 0.01;
